...
{/*}  useHotkeys(`${os === 'mac' ? 'cmd' : 'ctrl'}+k`, e => {
  ...
  return (
    <div className="sticky top-0 z-[100] border-b border-gray-900/10 bg-white dark:border-gray-500/30 dark:bg-gray-900">
      <Toaster />
{/*
...
*/}
      <div className="mx-auto flex w-full items-center justify-between space-x-4 px-4 py-1">
        ...
        <div className="flex items-center space-x-4 text-gray-700 md:flex-initial">
          {/*<button
